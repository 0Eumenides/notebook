import{_ as n,p as s,q as a,a1 as e}from"./framework-e03faf0e.js";const p={},t=e(`<h1 id="项目build" tabindex="-1"><a class="header-anchor" href="#项目build" aria-hidden="true">#</a> 项目build</h1><ol><li>在项目根目录下，也就是和<code>package.json</code>同级的目录下新建一个文件<code>vue.config.js</code>，在里面写入(有特殊需求可根据注释做相关修改，一般来说下面的配置可以直接用)：</li></ol><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code>module<span class="token punctuation">.</span>exports <span class="token operator">=</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ol start="2"><li>在项目根目录中，对项目进行打包<code>npm run build</code>，大多编译器都可以直接打包，如vscode。打包完成后，会在项目根目录下生成一个dist文件夹</li></ol><h1 id="nginx配置文件修改" tabindex="-1"><a class="header-anchor" href="#nginx配置文件修改" aria-hidden="true">#</a> Nginx配置文件修改</h1><p>在你想使用的域名下添加一段代码</p><div class="language-nginx line-numbers-mode" data-ext="nginx"><pre class="language-nginx"><code><span class="token directive"><span class="token keyword">server</span></span> <span class="token punctuation">{</span>
    ...
    <span class="token comment">#location /apis {</span>
     ...
     <span class="token comment"># }</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><code>nginx -s reload</code>重启下nginx</p><p>差不多已经完成了</p><p>接下来就只需在服务器上的<code>/usr/share/nginx/html/</code>文件夹下新建文件夹<code>project</code>，将刚刚打包好的dist文件夹中的三个文件放到<code>/usr/share/nginx/html/project</code>下。</p><p>ok，现在通过<code>域名/project</code>访问你的项目吧！</p>`,11),o=[t];function l(c,r){return s(),a("div",null,o)}const d=n(p,[["render",l],["__file","Vue项目部署.html.vue"]]);export{d as default};
